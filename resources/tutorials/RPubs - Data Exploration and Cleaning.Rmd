...
Create a table showing a breakdown of percentages by sex and casualty class. In terms of Casualty Class - 1 is Driver, 2 is Passenger and 3 is Pedestrian
```{r}
...
## Summary
And that's the end of this tutorial on data exploration and cleansing. This is one part of a series of practical data demos that Student Data Labs is running as part of the Vision Zero Innovation Lab. 

As a future exercise - take the new pedestrian_casualties file and explore the data, create some visualisations and do some analysis.
